...
void handleIRCommand() {
  ...
  // Convert the string code to an array
  int irSignal[100]; // Adjust size if needed
  int length = 0;
  
  char* token = strtok((char*)codeStr.c_str(), "+");
  while (token != NULL && length < 100) {
    irSignal[length++] = atoi(token);
    token = strtok(NULL, "+");
  }

  // Transmit IR signal
  irsend.begin();
  irsend.sendRaw(irSignal, length, carrier);
*/
  else {
    // Extract carrier frequency and IR code
    int carrierHz = server.arg("carrier").toInt();  //Example: 38000
    int carrierKhz = (carrierHz / 1000);
...
void sendIRRaw(String irData, int carrierKhz) {
  ...
  //http://192.168.1.104:8080/?carrier=38000&code=
